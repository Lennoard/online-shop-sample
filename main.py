...
def tela_principal_cliente():
    menu_cliente = '***** Online Shop Sample *****\n'
...
def sub_menu_admin():
    submenu_admin = 'Selecione a opção desejada:\n'
...
def sub_menu_cliente():
    submenu_cliente = 'Selecione a opção desejada:\n'
